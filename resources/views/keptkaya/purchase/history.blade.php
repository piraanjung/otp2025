                ...
                @else
                    ...
                    <div class="card mb-3 border-secondary">
                                ...
                                <table class="table table-sm mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ number_format($detail->amount_in_units, 2) }} {{ $detail->pricePoint->kp_units_info->unitname ?? 'N/A' }}</td>
                        ...
                        <div class="card-footer d-flex justify-content-end align-items-center">
                            <h6 class="me-3 mb-0">ยอดรวม: <span class="text-success">{{ number_format($transaction->total_amount, 2) }} บาท</span></h6>
                            <h6 class="me-3 mb-0">คะแนนรวม: <span class="text-primary">{{ number_format($transaction->total_points) }} คะแนน</span></h6>
                            <a href="{{ route('keptkaya.purchase.receipt', $transaction->id) }}" class="btn btn-sm btn-info">
