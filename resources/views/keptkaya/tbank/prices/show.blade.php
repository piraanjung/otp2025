    ...
    <div class="card">
        ...
        <div class="card-body">
            <dl class="row">
                ...
                <dd class="col-sm-8">{{ $price->recorder->firstname ?? 'N/A' }} {{ $price->recorder->lastname ?? 'N/A' }}</dd>
        ...
        <div class="card-footer d-flex justify-content-between">
            <a href="{{ route('keptkaya.tbank.prices.index') }}" class="btn btn-secondary">ย้อนกลับ</a>
            <a href="{{ route('keptkaya.tbank.prices.edit', $price->id) }}" class="btn btn-warning">แก้ไข</a>
        </div>
    </div>
</div>
@endsection
