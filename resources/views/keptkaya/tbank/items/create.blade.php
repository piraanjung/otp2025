...
<div class="row mb-3">
            <div class="col-md-6">
                <a href="{{ route('keptkaya.tbank.items.export') }}" class="btn btn-success">Export Items to Excel</a>
            </div>
            <div class="col-md-6">
                <form action="{{ route('keptkaya.tbank.items.import') }}" method="POST" enctype="multipart/form-data" class="d-flex">
                    @csrf
...
<div class="card card-info">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form action="{{ route('keptkaya.tbank.items.store') }}" class="form-horizontal" method="post" enctype="multipart/form-data" >
            @csrf
      <div class="card-body">
