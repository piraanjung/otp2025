            ...
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <form id="perPageForm" action="{{ route('keptkaya.staffs.index') }}" method="GET" class="d-flex align-items-center me-3">
                        ...
                        <a href="{{ route('keptkaya.staffs.create') }}" class="btn bg-gradient-primary btn-sm mb-0">เพิ่มเจ้าหน้าที่ใหม่</a>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">สิทธิ์เข้าถึงโมดูล</th>
                                    <th class="text-secondary opacity-7">การจัดการ</th>
                                </tr>
                                {{-- Search row --}}
                                <tr class="bg-gray-100">
                                    <th class="p-1">
                                        <input type="text" name="search_name" id="search_name" class="form-control form-control-sm" placeholder="ค้นหาชื่อเจ้าหน้าที่" value="{{ request('search_name') }}">
                                    </th>
                                    <th class="p-1">
                                    ...
                                    <th class="p-1">
                                        <div class="d-flex flex-column">
                                            <select name="search_can_access_waste_bank" id="search_can_access_waste_bank" class="form-select form-select-sm mb-1">
                                            ...
                                            <select name="search_can_access_annual_collection" id="search_can_access_annual_collection" class="form-select form-select-sm">
                            ...
                            <tbody id="staffTableBody">
                                @include('keptkaya.staffs._table_body')
                            </tbody>
                        </table>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function applyLiveSearch() {
            ...
            searchTimeout = setTimeout(() => {
                ...
                fetch(`{{ route('keptkaya.staffs.index') }}?${queryParams.toString()}`, {
                    headers: {
