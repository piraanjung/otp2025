    ...
    <div class="col-lg-8 col-md-10 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('keptkaya.payrate_per_months.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <label for="payrate_peryear" class="form-label">อัตราค่าบริการต่อเดือน <span class="text-danger">*</span></label>
                                <input type="number" step="0.01" class="form-control" id="payrate_permonth" name="payrate_permonth" value="{{ old('payrate_permont') }}" required placeholder="เช่น 1200.00">
                            ...
                            <div class="col-12 col-md-6">
                                 ...
                                 <input type="number" readonly class="form-control" id="payrate_peryear" name="payrate_peryear" value="{{ old('payrate_peryear') }}" required placeholder="เช่น 1200.00">
                                @error('payrate_peryear')
                                    <div class="text-danger text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
