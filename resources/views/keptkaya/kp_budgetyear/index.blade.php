...
<div class="card">
    <div class="card-header text-right">
        <a href="{{route('keptkaya.kp_budgetyear.create')}}" class="btn btn-primary">สร้างปีงบประมาณ</a>
    </div>
            ...
            <tbody>
                ...
                <tr>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right"
                                    ...
                                    <li><a class="dropdown-item text-center"
                                            href="{{ route('keptkaya.kp_budgetyear.edit', $budgetyear->id) }}">แก้ไขข้อมูล</a>
                                    </li>
                                    <li>
                                        @if ($budgetyear->deleted == 0)
                                            <form
                                                action="{{ route('keptkaya.kp_budgetyear.destroy', $budgetyear->id) }}"
                                                method="Post">
                                                @csrf
                                                @method('DELETE')
                    ...
                    {{-- <th class="d-flex">
                        ...
                        <a href="{{route('keptkaya.kp_budgetyear.edit',$budgetyear->id )}}" class="btn btn-warning">แก้ไขข้อมูล</a>
                        <form action="{{ route('keptkaya.kp_budgetyear.destroy', $budgetyear->id) }}" method="post" class="ml-auto">
                            @csrf
                            @method('DELETE')
