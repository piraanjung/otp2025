            ...
            <table class="table  table-striped datatable" id="DivIdToPrint">
                <thead class="bg-light">
                    <tr>
                        ...
                        <th class="text-center" width="8%">บ้านเลขที่</th>
                        <th class="text-center" width="10%">ยกยอดมา</th>
                        <th class="text-center" width="10%">มิเตอร์ปัจจุบัน</th>
                ...
                <tbody id="app">
                    ...
                    <tr data-id="{{$i}}" class="data">
                        ...
                        <td class="border-0 text-center">
                            ...
                            <input type="hidden" value="{{$item->id}}" name="data[{{$i}}][meter_id]">
                        </td>
                        <td class="border-0 text-left">
                            @if ($item->user_profile != null)
                            <span class="username" placeholder="กดดูประวัติมิเตอร์น้ำ" data-user_id="{{$item->user_profile['user_id']}}"><i class="fas fa-search-plus"></i>&nbsp;{{$item->user_profile['name']}}</span>
                        ...
                        @endif
                        <td class="border-0">
                            <input type="text" value="{{$item->invoice_last_inctive_inv_period[0]['currentmeter']}}" name="data[{{$i}}][lastmeter]" 
