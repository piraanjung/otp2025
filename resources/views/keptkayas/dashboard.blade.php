...
@section('content')
    ...
    <div class="app-content"> <!--begin::Container-->
      ...
      <div class="row">
        <h2 class="mb-0">จัดการถังขยะรายปี Dashboard</h2>
          ...
          <div class="card">
            <div class="card-body p-3 position-relative overflow-hidden min-height-500">
              ...
              <div id="globe" class="position-absolute end-0 bottom-n2 mt-sm-3 peekaboo">
                <canvas width="451" height="506" class="w-lg-100 h-lg-100 w-75 h-75 me-lg-0 me-n8 mt-lg-5" style="width: 451.828px; height: 506.922px;"></canvas>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row mt-4">
          ...
          <div class="card z-index-2">
            <div class="card-body p-2">
              <div class="bg-dark border-radius-md py-3 pe-1 mb-3">
                <div class="chart">
                  <canvas id="chart-bars" class="chart-canvas" height="340" width="1310" style="display: block; box-sizing: border-box; height: 170px; width: 655px;"></canvas>
                </div>
              </div>
        ...
        <div class="col-lg-7">
          <div class="card z-index-2">
            ...
            <div class="card-body p-3">
              <div class="chart">
                <canvas id="chart-line" class="chart-canvas" height="600" width="1286" style="display: block; box-sizing: border-box; height: 300px; width: 643px;"></canvas>
              </div>
            </div>
          </div>
        </div>
