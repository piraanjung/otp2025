...
<table width="95%" border="1" style="margin-top:8px !important;" class="t2 border-0">
    <tr>
        <td colspan="5" class="text-center head pt-2 pb-2">ใบเสร็จรับเงินค่าจัดเก็บขยะ (ต้นขั้ว)</td>
...
<table border="1" width="95%" class="t2" style="margin-top:1.4rem !important">
    <tr>
...
<table border="1" width="95%" class="t2" style="margin-top:1.1rem !important">
