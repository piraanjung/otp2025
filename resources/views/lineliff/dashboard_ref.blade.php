...
.menu button {
  ...
  border-radius:8px;
    ...
    <style>
        ...
        .menu-trigger-btn:active { transform: scale(0.9); }
        ...
        .modern-sidebar.active { left: 0; } /* เลื่อนออก */
        ...
        .sidebar-link i {
            ...
            color: #00b09b; width: 25px; text-align: center;
        }
...
<div class="modern-sidebar" id="mainSidebar">
    <div class="sidebar-header">
        <img src="https://profile.line-scdn.net/{{$userWastePref->user->image ?? ''}}" alt="Profile" class="sidebar-avatar">
        <div class="sidebar-user-info">
            <h5>{{$userWastePref->user->firstname ?? 'Guest'}}</h5>
    ...
    <div class="sidebar-content">
        <a href="#" class="sidebar-link active" data-id="home">
...
<script>
    ...
    function openMenu() {
        ...
        $('body').css('overflow', 'hidden'); // ป้องกันเลื่อนหน้าจอหลัง
    }
    ...
    $('#menuBackdrop').click(closeMenu); // กดที่ว่างๆ เพื่อปิด

    // Logic เดิมของคุณ (กดเมนูแล้วเปลี่ยนหน้า)
    $('.main_bottom_nav').click(function(e) {
        e.preventDefault();
        
        // Active State (Optional: ทำให้เมนูรู้ว่าเลือกอันไหนอยู่)
        ...
        // ปิดเมนูก่อน แล้วค่อยเปลี่ยนหน้า
        closeMenu();
        ...
        setTimeout(() => {
            ...
            // Scroll to top
            window.scrollTo(0,0);
        }, 300); // รอ Animation เมนูปิดนิดนึง
    });
});
