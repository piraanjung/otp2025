                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="cashier_id" id="cashier_id">
                            ...
                            <option value="{{$receiption->id}}">{{$receiption->firstname.' '.$receiption->lastname}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <table id="example" class="table text-nowrap" width="100%">
                <thead>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="text-center">ผู้รับเงิน: {{ collect($cashier_name)->isEmpty() ? '-' : $cashier_name->firstname.' '. $cashier_name->lastname}}</td>
                ...
                <tbody>
                    ...
                    <tr>
                        @if ($i++ ==1)
                        <td class="text-right">{{$infos[0]->accounts_id_fk}}</td>
                        <td class="text-right">{{$infos[0]->usermeterinfos->user_id}}</td>
                        <td class="text-right">{{$infos[0]->usermeterinfos->meternumber}}</td>
                        <td>{{$infos[0]->usermeterinfos->user->firstname.' '.$infos[0]->usermeterinfos->user->lastname}}</td>
                        <td class="text-right">{{$infos[0]->usermeterinfos->user->address}}</td>
                        <td class="text-right">{{$infos[0]->usermeterinfos->user->user_zone->zone_name}}</td>
                        <td class="text-right">{{collect($infos[0]->usermeterinfos->user->user_subzone)->isEmpty() ? '-' : '1'}}</td>
                        @else
                        <td class="text-right" style="opacity: 0">{{$infos[0]->accounts_id_fk}}</td>
                        <td class="text-right" style="opacity: 0">{{$infos[0]->usermeterinfos->user_id}}</td>
                        <td class="text-right" style="opacity: 0">{{$infos[0]->usermeterinfos->meternumber}}</td>
                        <td style="opacity: 0">{{$infos[0]->usermeterinfos->user->firstname.' '.$infos[0]->usermeterinfos->user->lastname}}</td>
                        <td class="text-right" style="opacity: 0">{{$infos[0]->usermeterinfos->user->address}}</td>
                        <td class="text-right" style="opacity: 0">{{$infos[0]->usermeterinfos->user->user_zone->zone_name}}</td>
                        <td class="text-right" style="opacity: 0">{{collect($infos[0]->usermeterinfos->user->user_subzone)->isEmpty() ? '-' : '1'}}</td>
                        @endif

                        <td class="text-right">{{$infos[0]->invoice_period->inv_p_name}}</td>
                        ...
                        <td class="text-right">{{ $infos[0]->accounting->user_payee->firstname }}</td>
                        <td class="text-right">{{ $infos[0]->acc_updated_at }}</td>
