...
@section('mainheader')
ล็อคมิเตอร์ผู้ค้างชำระเกิน 3 รอบบิล
@endsection
@section('nav')
...
<div class="row">
  ...
  <div class="col-lg-5">
      <form action="{{ url('/cutmeter/store/') }}" method="POST">
          @csrf
          ...
          <div class="card card-info">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                      <label>สถานะ:</label>
                      <select class="form-control " name="status" id="cutmeter_status_select"  >
                  ...
                  <div class="form-group">
                          ...
                          {{-- <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group row mt-2">
                                    ...
                                    <span class="form-control col-md-1 h5">{{ $i }}</span>
                      ...
                      <input type="submit" value="บันทึก" class="submit_btn btn btn-success ">
                  </div>
                  <!-- /.card-body -->
              </div>
      </form>
