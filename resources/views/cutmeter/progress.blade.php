...
@section('page-topic')
    ดำเนินการตัดมิเตอร์ ( สถานะ ตัดมิเตอร์ )
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('cutmeter.update', $cutmeter)}}" method="POST">
                ...
                @csrf
                {{-- ตัดมิเตอร์ --}}
                <div class="card multisteps-form__panel p-3 mt-6 border-radius-xl js-active"
                    data-animation="FadeIn" id="pd1">
                    <h5 class="font-weight-bolder">ตัดมิเตอร์</h5>
                        <div class="card" style="background-image: url('../../../assets/img/curved-images/white-curved.jpeg')">
                            ...
                            <div class="card-body p-3 position-relative">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="text-white text-sm text-end font-weight-bolder mt-auto mb-0">
                                            <div>ค้างชำระ</div> {{ $cutmeter->owe_count }}<div> รอบบิล</div></div>
                        ...
                        <label class="form-label">เจ้าหน้าที่ผู้ตัดมิเตอร์</label>
                        <div class="form-group">
                            <select name="twman1" class="form-control">
                                <option>เลือก</option>
                            ...
                            <select name="twman2" class="form-control mt-2">
                        ...
                        <div class="form-group">
                            <select name="status" class="form-control">
                                <option value="cutmeter" selected>ตัดมิเตอร์</option>
                            </select>
                        </div>


                        <input type="submit" class="btn  btn-sm float-end mt-3 mb-0"
                            value="บันทึกข้อมูลการตัดหม้อ">
                </div>
            </form>
