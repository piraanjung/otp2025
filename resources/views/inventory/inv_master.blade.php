            ...
            <div class="col-md-2 sidebar p-3 d-none d-md-block">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mt-3">
                        <small class="text-uppercase text-muted ps-3 fw-bold" style="font-size: 0.75rem;">การตั้งค่า
                            (Settings)</small>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.workflows.index') }}" class="nav-link text-dark">
                            <i class="material-icons-round align-middle me-2 text-secondary">straighten</i>
                            จัดการสายการอนุมัติ
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="{{ route('inventory.locations.index') }}" class="nav-link text-dark">
                            <i class="material-icons-round align-middle me-2 text-secondary">straighten</i> locations
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.suppliers.index') }}" class="nav-link text-dark">
                            <i class="material-icons-round align-middle me-2 text-secondary">straighten</i> supplier
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-10 p-0">
                <div class="top-navbar d-flex justify-content-between align-items-center">
                    ...
                    <div class="user-profile">
                        ...
                        <img src="https://ui-avatars.com/api/?name=Admin&background=0D8ABC&color=fff&rounded=true"
                            width="40" alt="user">
                    </div>
                </div>
