    ...
    <nav class="navbar navbar-expand-lg bg-light shadow-lg">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="{{ asset('templatemo/images/logo.png') }}" class="logo img-fluid" alt="Kind Heart Charity">
                <span>
                    เทศบาลตำบลห้องแซง
                    <small>อำเภอเลิงนกทา จังหวัดยโสธร</small>
                </span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="{{ route('login') }}">ระบบประปา</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="#section_2">ระบบจัดการขยะชุมชน</a>
                    </li>
                        ...
                        <div id="hero-slide" class="carousel carousel-fade slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{ asset('templatemo/images/slide/volunteer-helping-with-donation-box.jpg') }}"
                                ...
                                <div class="carousel-item">
                                    <img src="{{ asset('templatemo/images/slide/volunteer-selecting-organizing-clothes-donations-charity.jpg') }}"
                                        class="carousel-image img-fluid" alt="...">
                                ...
                                <div class="carousel-item">
                                    <img src="{{ asset('templatemo/images/slide/medium-shot-people-collecting-donations.jpg') }}"
                                        class="carousel-image img-fluid" alt="...">
                    ...
                    <div class="col-lg-3 cus-btn col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                ...
                                <p class="featured-block-text"><strong>ระบบ</strong> จัดการขยะชุมชน</p>
                            </a>
                        </div>
                    </div>
