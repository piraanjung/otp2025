            ...
            <div class="multisteps-form mb-5">
                ...
                <div class="row">
                    <div class="col-12 col-lg-10 m-auto">
                        <form class="multisteps-form__form mb-8" action="{{ url('/users/store') }}" method="post"
                            style="height: 492px;">
                            @csrf
                                ...
                                <div class="multisteps-form__content">
                                    <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input type="text" class="form-control" readonly name="new_meter_id"
                                                value="{{ $meternumber }}">
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <label>เลขมิเตอร์</label>
                                            <input type="text" class="form-control" readonly name="meternumber"
                                                id="meternumber" value="{{ $meternumber }}">
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" readonly name="counter_unit"
                                                id="counter_unit" value="">
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <label>ขนาดมิเตอร์</label>
                                            <input type="text" class="form-control" readonly name="metersize"
                                                id="metersize">
                                        </div>
                                        <div class="col-12 col-sm-6">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            ...
                                            <?php $year = date('Y') + 543;
                                            $now = date('d/m/' . $year); ?>
                                            <input type="text" class="form-control datepicker" name="acceptance_date"
                                                id="acceptance_date" value="{{ $now }}">
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <label>วิธีชำระเงิน</label>
                                            <span class="ml-auto text-right text-semibold text-reagent-gray">
                                                <input type="text" class="form-control" readonly name="payment_id"
                                                    value="1">
                                            </span>
                                        </div>
                                        <div class="col-12 col-sm-4">
                            ...
                            <div class="card multisteps-form__panel p-3 border-radius-xl bg-white" data-animation="FadeIn"
                                ...
                                <div class="multisteps-form__content text-center">
                                    <button class="btn ms-auto mb-0 bg-green-500 hover:bg-green-300" type="submit"
                                        title="บันทึกข้อมูล">บันทึกข้อมูล</button>
