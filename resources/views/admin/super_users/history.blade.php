    ...
    <div class="container-fluid my-3 py-3">
        <div class="row mb-5">
            <div class="col-lg-3">
                <div class="card position-sticky top-1">
                    <ul class="nav flex-column bg-white border-radius-lg p-3">
                        @foreach ($user[0]->usermeterinfos as $meter)
                            <li class="nav-item">
                                <a class="nav-link text-body" data-scroll="" href="#meter{{$meter->meter_id}}">
                                    <div class="icon me-2">
                                    ...
                                    <span class="text-sm">{{ $meter->meternumber }}</span>
                                </a>
                            </li>
                        @endforeach
            ...
            <div class="col-lg-9 mt-lg-0 mt-4">
                @foreach ($user[0]->usermeterinfos as $key => $meter)
                    @if ($key == 0)
                        <div class="card" id="meter{{ $meter->meter_id }}">
                    @else
                        <div class="card mt-4" id="meter{{ $meter->meter_id }}">
                    @endif
                            ...
                            <div class="card-body pt-0">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($meter->invoice as $invoice)
                                        <?php
