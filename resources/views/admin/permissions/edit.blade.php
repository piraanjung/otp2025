                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1 col-4">
                                        <input type="text" id="name" name="name"
                                            ...
                                            class="block w-full appearance-none mt-2 bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                                            value="{{ $permission->description }}" />
                                            <input type="text" id="permission_group" name="permission_group"
                                            class="block w-full appearance-none mt-2 bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5"
