<div class="row">
    ...
    <div class="form-group col-12 col-md-4">
        ...
        <input type="text" class="form-control" id="organize_road"
            value="{{ isset($organizations['organize_road']) ? $organizations['organize_road'] : 'พระยืน-โพนทอง' }}"
            name="organize_road">
    ...
    <div class="form-group col-12 col-md-4">
        ...
        <input type="text" class="form-control" id="organize_tambon"
            value="{{ isset($organizations['organize_tambon']) ? $organizations['organize_tambon'] : 'ขามป้อม' }}"
    ...
    <div class="form-group col-12 col-md-4">
        ...
        <input type="text" class="form-control" id="organize_district"
            value="{{ isset($organizations['organize_district']) ? $organizations['organize_district'] : 'พระยืน' }}"
    ...
    <div class="form-group col-12 col-md-4">
        ...
        <input type="text" class="form-control" id="organize_province"
            value="{{ isset($organizations['organize_province']) ? $organizations['organize_province'] : 'ขอนแก่น' }}"
    ...
    <div class="form-group col-12 col-md-4">
        ...
        <input type="text" class="form-control" id="organize_zipcode"
            value="{{ isset($organizations['organize_zipcode']) ? $organizations['organize_zipcode'] : '40003' }}"
