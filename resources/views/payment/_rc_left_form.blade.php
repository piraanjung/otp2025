...
<table width="95%" style="margin-top:8px !important;" class="t2 border-0">
    <tr>
...
<table border="0" width="95%" class="t2" style="margin-top:1.4rem !important">
    <tr>
...
<table border="0" width="95%" class="t2" style="margin-top:1.1rem !important">
    ...
    @foreach ($invoicesPaidForPrint as $key => $item)
        <tr>
            ...
            <td class="text-right number t2-pr-3">{{ number_format($paid) }}</td>
        </tr>
    @endforeach
    ...
    <tr>
        <td colspan="3">&nbsp;</td>
        <td class="text-right t2-pr-3 number head2">
            {{ number_format($total,2) }}
        </td>
    </tr>
...
<table border="0" width="95%" class="mt-4">
    <tr>
