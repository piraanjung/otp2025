...
class CreateUserWastePreferencesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_waste_preferences', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('user_waste_preferences');
    }
}