...
class ZonesSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('zone')->insert([
            ...
            ['zone_name' =>'หมู่ 14', 'location' => 'ตำบลห้องแซง อำเภอเลิงนกทา จังหวัดยโสธร', 'tambon_code' => '471804'],
            ['zone_name' =>'หมู่ 15', 'location' => 'ตำบลห้องแซง อำเภอเลิงนกทา จังหวัดยโสธร', 'tambon_code' => '471804'],
            ['zone_name' =>'หมู่ 16', 'location' => 'ตำบลห้องแซง อำเภอเลิงนกทา จังหวัดยโสธร', 'tambon_code' => '471804'],
            ['zone_name' =>'หมู่ 17', 'location' => 'ตำบลห้องแซง อำเภอเลิงนกทา จังหวัดยโสธร', 'tambon_code' => '471804'],
