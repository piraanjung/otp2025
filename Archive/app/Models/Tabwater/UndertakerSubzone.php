...
{
    use HasFactory;
    protected $table = 'tw_undertaker_subzones';
    ...
    public function subzone(){
     ...
     public function subzoneInvoiceStatusCount($status, $subzone_id, $inv_period){
        return TwUsersInfo::where('undertake_subzone_id', $subzone_id)
    ...
    public function subzoneMemberCount($subzone_id){
        return TwUsersInfo::where('undertake_subzone_id', $subzone_id)->where('status', 'active')->count();
    }
