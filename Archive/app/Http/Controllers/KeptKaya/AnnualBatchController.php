...
class AnnualBatchController extends Controller
{
    ...
    public function index()
    {
        ...
        $batches = AnnualTrashSubscription::select(
            'fiscal_year',
    ...
    public function store(Request $request)
    {
        ...
        if (AnnualTrashSubscription::where('fiscal_year', $targetFiscalYear)->exists()) {
        ...
        try {
            ...
            $activeBins = AnnualTrash::where('is_active_for_annual_collection', true)
                ->where('status', 'active')
            ...
            foreach ($activeBins as $bin) {
                ...
                $rateCard = AnnualTrashPayratePerMonth::where('kp_usergroup_idfk', $userGroupId)
    ...
    public function destroy($fiscal_year)
    {
        ...
        $hasPayment = AnnualTrashSubscription::where('fiscal_year', $fiscal_year)
        ...
        AnnualTrashSubscription::where('fiscal_year', $fiscal_year)->delete();
