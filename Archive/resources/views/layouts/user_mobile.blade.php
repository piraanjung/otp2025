...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 pr-5"
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
                target="_blank">
                <img src="{{ asset('logo/ku1.png') }}" class="navbar-brand-img h-100" alt="main_logo">
                <span class="ms-1 font-weight-bold">Kasetsart University</span>
            </a>
        </div>
            ...
            <div class="card  mb-4">
                <div class="card-body p-3">
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        <p class="text-sm mb-0 text-capitalize font-weight-bold">KU-EnvSoGo</p>
                        <h5 class="font-weight-bolder mb-0">
                          {{-- {{$staff->firstname." ".$staff->lastname}} --}}
                          
                        </h5>
                        <p class="text-danger text-sm font-weight-bolder">Env-Keptkaya</ย>
                      </div>
                    </div>
    ...
    <li class="nav-item">
        <a class="nav-link  @yield('nav-dashboard')" href="{{ route('lineliff.index') }}">
            <div
