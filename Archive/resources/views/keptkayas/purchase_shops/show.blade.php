    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-footer d-flex justify-content-between">
                <a href="{{ route('keptkayas.purchase-shops.index') }}" class="btn btn-secondary">ย้อนกลับ</a>
                <a href="{{ route('keptkayas.purchase-shops.edit', $shop->id) }}" class="btn btn-warning">แก้ไข</a>
            </div>
        </div>
    </div>
@endsection