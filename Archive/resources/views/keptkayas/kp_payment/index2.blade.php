...
<div class="preloader-wrapper">
    ...
    <div class="row">
        <div class="col-12 mb-2">
            <form action="{{ route('kp_payment.index') }}" method="get">
                @csrf
                <div class="card">
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('kp_payment.store') }}" method="POST" >
    ...
    <!-- Modal -->
    <form action="{{ route('kp_payment.store') }}" method="post" onsubmit="return check()">
        @csrf
