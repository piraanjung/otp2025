...
@section('content')
<div class="container">
    <h2>เพิ่มถังขยะ รายปี ใหม่</h2>
    <hr>

    <form action="{{ route('keptkayas.bins.store') }}" method="POST">
        @csrf
        ...
        <input type="hidden" name="bin_type" value="ab">
        <button type="submit" class="btn btn-success">บันทึกข้อมูล</button>
        <a href="{{ route('keptkayas.bins.index') }}" class="btn btn-secondary">ยกเลิก</a>
    </form>
</div>
@endsection
