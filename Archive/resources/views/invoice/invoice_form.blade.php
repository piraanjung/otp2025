...
{{-- <table>
    ...
    <tr>
        <td colspan="4">
            <php echo '<img src="data:image/png;base64,' . DNS1D::getBarcodePNG("OE1906-04", "C128" )
    ...
    <tr>
        <td id='owner' colspan="4">
            <div class="inner">
                <div class="title">เทศบาลตำบลขามป้อม</div>
                <div class="address">ตำบลขามป้อม อำเภอพระยืน จังหวัดขอนแก่น 40003</div>
...
{{-- <div id="printpage">
    ...
    <table class="table mt-2">
        ...
        <tr>
            <td colspan="3">
                <div>คิดเป็นเงิน {{$item->used_water_net}} x {{$item->users->usermeter_info->counter_unit}} บาท:หน่วย
                </div>
            </td>
            <tdfont-weight-bold bg-warning text-black"> {{$item->must_paid}} บาท</td>
        </tr>
