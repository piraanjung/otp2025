        ...
        <div class="row mb-5">
            <div class="col-lg-3">
                <div class="card position-sticky top-1">
                    <?php $arrs = [['id' => 'org_info', 'text' => 'ชื่อหน่วยองค์กรและหน่วยงาน'], ['id' => 'logo', 'text' => 'ตราสัญลักษณ์'], ['id' => 'address', 'text' => 'ที่อยู่'], ['id' => 'sign', 'text' => 'ลายเซ็นต์'], ['id' => 'meter_code', 'text' => 'รหัสเลขมิเตอร์'], ['id' => 'inv_period', 'text' => 'เกี่ยวกับใบแจ้งหนี้']];
                    ?>
