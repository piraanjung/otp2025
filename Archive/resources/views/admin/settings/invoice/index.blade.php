...
@section('content')
<form method="post" action="{{ route('admin.settings.invoice_and_vat') }}" enctype="multipart/form-data">
    @csrf
    <div class="container-fluid my-3 py-3">
        <div class="row mb-5">
            <div class="col-lg-3">
                <div class="card position-sticky top-1">
                    <?php $arrs = [['id' => 'meter_code', 'text' => 'รหัสเลขมิเตอร์'],
                                ['id' => 'inv_period', 'text' => 'เกี่ยวกับใบแจ้งหนี้'],['id' => 'vat', 'text' => 'ภาษีมูลค่าเพิ่ม']];
                    ?>
            ...
            <div class="col-lg-9 mt-lg-0 mt-4">
                ...
                <div class="card mt-4" id="{{ $arrs[2]['id'] }}">
                    ...
                    <div class="card-body pt-0">
                        {{-- ใบแจ้งหนี้ --}}
                        @include('admin.settings.invoice.vat')
                    </div>
                </div>
            </div>
        </div>
