...
class UserMatchingAnnualTrashsController extends Controller
{
    ...
    public function edit(FoodAnnualTrash $bin)
    {
        return $bin;
        return view('foodwaste.w.waste_bins.edit', compact('AnnualTrash'));
    }
